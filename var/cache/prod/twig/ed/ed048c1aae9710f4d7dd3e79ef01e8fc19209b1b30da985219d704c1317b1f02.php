...
$context["action"], "type", [], "any", true, true) && ($this->getAttribute($context["action"], "type", []) == "button"))) {
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Helpers:bootstrap_popup.html.twig", "C:\\laragon\\www\\testPrestashop\\src\\PrestaShopBundle/Resources/views/Admin/Helpers/bootstrap_popup.html.twig");
    }
}
