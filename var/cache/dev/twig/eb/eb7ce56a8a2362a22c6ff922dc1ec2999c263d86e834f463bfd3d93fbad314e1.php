...
class __TwigTemplate_4dc19eaf320854db3c7443e9e7f5177553edf78152610f17a144685c05b2944e extends \Twig\Template
{
    ...
    <div class=\"row\">
      <div class=\"col\">
        ...
        echo "\">
          ";
        // line 67
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Add a new address", [], "Admin.Orderscustomers.Feature"), "html", null, true);
        echo "
        </a>
      </div>
    </div>
    ...
    <div class=\"row\">
      <div class=\"col\">
        <a class=\"btn btn-primary\" id=\"js-add-address-btn\" href=\"{{ path('admin_addresses_create', {'liteDisplaying': 1, 'submitFormAjax': 1}) }}\">
          {{ 'Add a new address'|trans({}, 'Admin.Orderscustomers.Feature') }}
        </a>
      </div>
    </div>
  </div>
</div>
", "@PrestaShop/Admin/Sell/Order/Order/Blocks/Create/addresses.html.twig", "C:\\laragon\\www\\testPrestashop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Order\\Order\\Blocks\\Create\\addresses.html.twig");
    }
}
