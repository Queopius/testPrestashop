...
class __TwigTemplate_f4aa63d7915e2a9b2bb08a51d9bb358bbdcd1a0dd76ed514c230edd217361ac4 extends \Twig\Template
{
...
<tr id=\"editProductTableRowTemplate\" class=\"d-none editProductRow\">
  ...
  <td class=\"cellProductTaxes pr-5\">
    ";
        // line 30
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["editProductRowForm"] ?? $this->getContext($context, "editProductRowForm")), "price_tax_excluded", []), 'row');
        echo "
    ";
        // line 31
  ...
  ";
      ...
      ";
            // line 42
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["editProductRowForm"] ?? $this->getContext($context, "editProductRowForm")), "invoice", []), 'row', ["attr" => ["data-modal-edit-price-title" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Edit the price", [], "Admin.Orderscustomers.Feature"), "data-modal-edit-price-apply" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Update", [], "Admin.Actions"), "data-modal-edit-price-cancel" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Cancel", [], "Admin.Actions"), "data-modal-edit-price-body" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Are you sure you want to edit this product price? It will be applied to all invoices of this order.", [], "Admin.Orderscustomers.Notification")]]);
            // line 49
            echo "
    </td>
  ";
...
";
    ...
    {
        return array (  82 => 55,  78 => 54,  74 => 52,  69 => 49,  67 => 42,  64 => 41,  62 => 40,  53 => 34,  47 => 31,  43 => 30,  36 => 25,);
    }
...
", "@PrestaShop/Admin/Sell/Order/Order/Blocks/View/edit_product_row.html.twig", "C:\\laragon\\www\\testPrestashop\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Order\\Order\\Blocks\\View\\edit_product_row.html.twig");
    }
}
